...
export const MIGRATION_REGISTRY: MigrationEntry[] = [
  ...
  // Wire-the-loop — planner goal + follow-on suggestions on workflows.
  { route: "workflows-v3", label: "Workflows — goal + follow-ons", collection: "workflows", detectField: "suggested_next", note: "adds goal + suggested_next to workflows" },
  ...
  // PR-Wire-Directives — owner standing orders on businesses.
  { route: "businesses", label: "Businesses — standing directives", collection: "businesses", detectField: "staff_directives", note: "adds staff_directives (owner standing orders every specialist obeys)" },
