const FIELDS = [
  ...
  { name: "outcome_status", type: "text", required: true },
...
const INDEXES = [
  "CREATE UNIQUE INDEX idx_mission_outcomes_identity ON mission_outcomes (outcome_id)",
  "CREATE INDEX idx_mission_outcomes_user_mission ON mission_outcomes (user, mission_id)",
  "CREATE INDEX idx_mission_outcomes_user_status ON mission_outcomes (user, outcome_status)",
  "CREATE INDEX idx_mission_outcomes_learning ON mission_outcomes (user, approved_for_learning)",
];
