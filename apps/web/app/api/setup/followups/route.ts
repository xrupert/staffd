/**
 * Idempotent setup for `followups` (W95.4a) — scheduled follow-ups with a
 * contact. USER_OWNED. Gated by proxy.ts dual-auth.
 */
...
const FIELDS = [
  ...
  { name: "status", type: "text", required: false },   // pending | done
