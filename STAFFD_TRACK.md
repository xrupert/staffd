...
- **Next (await SA dispatch):** W95.2 partition substrate (customer_id stamping wrapper + Listmonk list-per-customer) → .3 upload → .4 expand intents + delegation → .5 autopilot → .6 Chatwoot/Plausible → .7 repoint W80/W92.
